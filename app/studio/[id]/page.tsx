  ...
  return (
    <main style={{ backgroundColor: 'var(--bg)', height: '100vh', display: 'flex', flexDirection: 'column', fontFamily: 'var(--font-serif)', color: 'var(--text)', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        {/* ── CONTEXT PANEL ── */}
        {/* Outer wrapper has position:relative but NO overflow:hidden so the pull tab is never clipped */}
        <div style={{
          position: 'relative',
          flexShrink: 0,
          display: 'flex',
          ...
          {/* Pull tab — lives outside the clipping boundary, always visible */}
          <div
